...
merge_whitelists<-function(dna_bam, rna_bam, ref, single.sample.merged){
  ...
  if(nrow(single.sample.merged[[4]])==0){
    all_whitelist_merged<-read.csv("Func.refGene.x,Gene.refGene.x,GeneDetail.refGene.x,ExonicFunc.refGene.x,AAChange.refGene.x,genomicSuperDups.x,ExAC_ALL.x,ExAC_AFR.x,ExAC_AMR.x,ExAC_EAS.x,ExAC_FIN.x,ExAC_NFE.x,ExAC_OTH.x,ExAC_SAS.x,gnomad_exome_AF.x,gnomad_exome_AF_popmax.x,gnomad_exome_AF_male.x,gnomad_exome_AF_female.x,gnomad_exome_AF_raw.x,gnomad_exome_AF_afr.x,gnomad_exome_AF_sas.x,gnomad_exome_AF_amr.x,gnomad_exome_AF_eas.x,gnomad_exome_AF_nfe.x,gnomad_exome_AF_fin.x,gnomad_exome_AF_asj.x,gnomad_exome_AF_oth.x,gnomad_exome_non_topmed_AF_popmax.x,gnomad_exome_non_neuro_AF_popmax.x,gnomad_exome_non_cancer_AF_popmax.x,gnomad_exome_controls_AF_popmax.x,gnomad_genome_AF.x,gnomad_genome_AF_raw.x,gnomad_genome_AF_male.x,gnomad_genome_AF_female.x,gnomad_genome_AF_afr.x,gnomad_genome_AF_ami.x,gnomad_genome_AF_amr.x,gnomad_genome_AF_asj.x,gnomad_genome_AF_eas.x,gnomad_genome_AF_fin.x,gnomad_genome_AF_nfe.x,gnomad_genome_AF_oth.x,gnomad_genome_AF_sas.x,avsnp150.x,esp6500siv2_all.x,X1000g2015aug_all.x,cosmic91_coding.x,cosmic91_noncoding.x,SIFT_score.x,SIFT_converted_rankscore.x,SIFT_pred.x,Polyphen2_HDIV_score.x,Polyphen2_HDIV_rankscore.x,Polyphen2_HDIV_pred.x,Polyphen2_HVAR_score.x,Polyphen2_HVAR_rankscore.x,Polyphen2_HVAR_pred.x,LRT_score.x,LRT_converted_rankscore.x,LRT_pred.x,MutationTaster_score.x,MutationTaster_converted_rankscore.x,MutationTaster_pred.x,MutationAssessor_score.x,MutationAssessor_score_rankscore.x,MutationAssessor_pred.x,FATHMM_score.x,FATHMM_converted_rankscore.x,FATHMM_pred.x,PROVEAN_score.x,PROVEAN_converted_rankscore.x,PROVEAN_pred.x,VEST3_score.x,VEST3_rankscore.x,MetaSVM_score.x,MetaSVM_rankscore.x,MetaSVM_pred.x,MetaLR_score.x,MetaLR_rankscore.x,MetaLR_pred.x,M.CAP_score.x,M.CAP_rankscore.x,M.CAP_pred.x,REVEL_score.x,REVEL_rankscore.x,MutPred_score.x,MutPred_rankscore.x,CADD_raw.x,CADD_raw_rankscore.x,CADD_phred.x,DANN_score.x,DANN_rankscore.x,fathmm.MKL_coding_score.x,fathmm.MKL_coding_rankscore.x,fathmm.MKL_coding_pred.x,Eigen_coding_or_noncoding.x,Eigen.raw.x,Eigen.PC.raw.x,GenoCanyon_score.x,GenoCanyon_score_rankscore.x,integrated_fitCons_score.x,integrated_fitCons_score_rankscore.x,integrated_confidence_value.x,GERP.._RS.x,GERP.._RS_rankscore.x,phyloP100way_vertebrate.x,phyloP100way_vertebrate_rankscore.x,phyloP20way_mammalian.x,phyloP20way_mammalian_rankscore.x,phastCons100way_vertebrate.x,phastCons100way_vertebrate_rankscore.x,phastCons20way_mammalian.x,phastCons20way_mammalian_rankscore.x,SiPhy_29way_logOdds.x,SiPhy_29way_logOdds_rankscore.x,Interpro_domain.x,GTEx_V6p_gene.x,GTEx_V6p_tissue.x,cadd16gt10.x,nci60.x,CLNALLELEID.x,CLNDN.x,CLNDISDB.x,CLNREVSTAT.x,CLNSIG.x,CHROM_POS_REF_ALT,CHROM,POS,ID,REF,ALT,ANNOVAR_DATE,Func.ensGene,Gene.ensGene,GeneDetail.ensGene,ExonicFunc.ensGene,AAChange.ensGene,ALLELE_END,HC_AC,HC_AF,HC_AN,HC_BaseQRankSum,HC_ClippingRankSum,HC_DP,HC_ExcessHet,HC_FS,HC_MLEAC,HC_MLEAF,HC_MQ,HC_MQRankSum,HC_QD,HC_ReadPosRankSum,HC_SOR,HC_QUAL,HC_FILTER,DV_all.info.parsed,DV_QUAL,DV_FILTER,S2_SNVHPOL,S2_MQ,S2_QUAL,S2_FILTER,Caller_Filter,exonic,whitelist,rare.variants,not.syn,not.superdups,basic.filters,pop.freq.max.all,not.repeatmasker,nCallers,afMax,dpMax,HC_GT,HC_AD,HC_DP.1,HC_GQ,HC_PL,DV_GT,DV_GQ,DV_DP,DV_AD,DV_VAF,DV_PL,S2_GT,S2_GQ,S2_GQX,S2_DP,S2_DPF,S2_AD,S2_ADF,S2_ADR,S2_SB,S2_FT,S2_PL,S2_PS,S2_DPI,Chr,Start,End,Ref,Alt,DNA_depth_total,DNA_depth_alt,DNA_AF,RNA_depth_total,RNA_depth_alt,RNA_AF,Sample_ID")
